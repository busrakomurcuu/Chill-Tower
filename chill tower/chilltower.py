# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 15:59:51 2024
...
zemin = pg.image.load(r"C:\Users\BÜŞRA\Desktop\oyunson\materyal\zemin_buz.jpg")
...
karakter = pg.image.load(r"C:\Users\BÜŞRA\Desktop\oyunson\materyal\karakter_ucak.png")
...
buz_sutun = pg.image.load(r"C:\Users\BÜŞRA\Desktop\oyunson\materyal\ice.png")
buz_sutun_list = []
...
oyun_aktif = False
oyun_basla = pg.image.load(r"C:\Users\BÜŞRA\Desktop\materyal\Yeni klasör\başlangıç.png")
oyun_basla_rect = oyun_basla.get_rect(center=(140,180))
oyun_basla = pg.transform.rotozoom(oyun_basla,0,1.4)

oyun_bitti_img = pg.image.load(r"C:\Users\BÜŞRA\Desktop\materyal\Yeni klasör\oyun_bitti.png")
oyun_bitti_img = pg.transform.rotozoom(oyun_basla,0,1.4)
oyun_bitti_rect = oyun_bitti_img.get_rect(center=(140,180))

yildiz = pg.image.load(r"C:\Users\BÜŞRA\Desktop\materyal\Yeni klasör\star.png")
